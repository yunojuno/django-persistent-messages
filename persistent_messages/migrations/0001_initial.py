...
# HACK: you shouldn't import models directly, but we need to do this to
# ensure that overriding the MESSAGE_TYPES setting locally doesn't
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "level",
                    models.IntegerField(
                        choices=PersistentMessage.LEVEL_TAG_CHOICES,
                        default=20,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="User-defined tags that are combined with the default_tags and passed to messages framework as extra_tags.",
                        max_length=100,
                    ),
                ),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Specific groups to target - used when target is USERS_OR_GROUPS",
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Specific users to target - used when target is USERS_OR_GROUPS",
                        related_name="persistent_messages",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
